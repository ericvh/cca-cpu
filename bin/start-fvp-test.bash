...
export ARTIFACTS="/workspaces/artifacts/test-fvp"
export LINUX_BASE_ADDR="0x80080000"
export INITRD_BASE_ADDR="0x84000000"
...
docker run --rm --name fvp -i -t \
		...
		-C bp.secureflashloader.fname=$ARTIFACTS/bl1.bin \
		-C bp.flashloader0.fname=$ARTIFACTS/fip.bin \
